...
class ViewMetadataDao(implicit ex: ExecutionContext)  {
...
//
//
//  def lastEventNr(id: ViewMetadataId): CollectionCommand =
...
//
//  protected val viewMetadataPropertyName = "view_metadata"
//
